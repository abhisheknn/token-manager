...
public class AuthControllerImpl implements AuthController {
	...
	//@Override
	public ResponseEntity register( @Valid @RequestBody Machine entity) {
		authService.create(entity);
		URI location =ServletUriComponentsBuilder.fromCurrentRequest().path("{name}").buildAndExpand(entity.getName()).toUri();
	...
	public Response refreshToken(@RequestBody Machine entity) {
		return Response.ok(authService.refreshToken(entity.getName())).build();
	}
